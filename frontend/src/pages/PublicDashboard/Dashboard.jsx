...
const DashboardPage = () => {
  const teamData = [
    {
      ...
      decription: "Local basketball team from Australia",
      manager: "John",
      captain: "Michael",
      status: "Active",
      playercount: "12",
    ...
    {
      teamname: "LIV-Club",
      decription: "Local basketball team from New York",
      manager: "James",
      captain: "Mathew",
      status: "Active",
      playercount: "22",
    ...
    {
      teamname: "Barcelona",
      decription: "Local basketball team from Germany",
      manager: "John",
      captain: "Paul",
      status: "Active",
      playercount: "11",
  ...
  const gameData = [
    {
      name: "Thunderbolts",
      sport_event_name: "Local basketball team from Australia",
      start_datetime: "John",
      location: "Michael",
      status: "Active",
      teams_count: "12",
    ...
    <div className={classes.container}>
      ...
      <div className={classes.sidebar}>
        ...
        <div className={classes.matchCard}>
          ...
          <p className={classes.matchsubText}>
      ...
      <div className={classes.content}>
        ...
        <div className="latestVideos">
          <h3 className="tableTitle" style={{ color: "black" }}>
            🏆 Team
          </h3>
